...
export const translations = {
  en: {
    ...
    lbl_technical_rate: "Tech Failure Rate",
    score_excellent: "Excellent",
    score_good: "Good",
    score_poor: "Needs Training",
    score_critical: "Critical Misuse",
    reputation_desc: "Analysis of equipment failures to determine department commitment and training needs.",
    smart_assistant: "Smart Engineering Assistant",
    historical_matches: "Historical Matches",
    avg_repair_time: "Avg Repair Time",
    common_parts: "Frequently Used Parts",
  ...
  ar: {
    ...
    tab_training: "لوحة تدريب التمريض",
    ...
    rfid_audit: "جرد RFID",
    rfid_gate_monitor: "مراقبة البوابات الحية",
    ...
    gate_network_inactive: "شبكة البوابات غير متصلة",
    activate_gates: "تفعيل شبكة البوابات",
    deactivate_gates: "إيقاف المراقبة",
    reader_status: "حالة القارئ",
    reader_online: "متصل",
    reader_offline: "غير متصل",
    gate_ic: "مدخل العناية المركزة",
    gate_er: "باب الطوارئ الرئيسي",
    gate_or: "جناح العمليات",
    ...
    smart_point_subtitle: "تشخيص فوري ومساعدة ذاتية",
    quick_guide: "دليل الاستخدام السريع",
    troubleshooting: "حلول المشاكل الشائعة",
    is_problem_solved: "هل تم حل المشكلة؟",
    btn_solved: "نعم، تم الحل",
    btn_not_solved: "لا، إبلاغ عن عطل",
    manual_link: "فتح الكتيب الكامل",
    status_check: "فحص النظام",
    reputation_score: "السمعة والالتزام",
    misuse_index: "معدل سوء الاستخدام",
    compliant_depts: "الأقسام الأكثر التزاماً",
    high_misuse_depts: "الأقسام الأكثر سوء استخدام",
    asset_reputation: "سمعة الجهاز (كثرة الأعطال)",
